...
class ContentExtractor:
    ...
    def extract(self, html: str, url: str) -> Optional[Dict[str, Any]]:
        ...
        if 'lance.com.br' in domain:
            ...
            # Esses sites usam uma estrutura de artigo bastante padrão que o seletor abaixo captura bem.
            cleaned_container = soup.select_one('article .article-body')
            logger.info(f"INFO ({domain}): Contêiner principal encontrado com o seletor: 'article .article-body'")
